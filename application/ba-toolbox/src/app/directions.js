...
export default function Directions() {
    return (
        <div className={styles.grid}>
            ...
            >
            <h2>My Page <br></br>我的主页 <span>-&gt;</span></h2>
            ...
            <a
                ...
                rel="noopener noreferrer"
            >
            <h2>Experiments <br></br>我的试验田 <span>-&gt;</span></h2>
            ...
            <a
                ...
                rel="noopener noreferrer"
            >
            <h2>GitHub Page <br></br> GitHub主页 <span>-&gt;</span></h2>
            <p>Track progress and contribute to this project. </p>
            <p>简体中文的项目相关介绍和内容请点此进入GitHub查看. </p>
            </a>
            ...
            rel="noopener noreferrer"
            >
            <h2>Other Projects <br></br> 其他项目 <span>-&gt;</span></h2>
